...
export default function LoginSignupPage() {
  ...
  const redirectMode = (search.get('redirectMode') || 'self').toLowerCase();
  ...
  return (
    <div className="w-full">
      {/* Clean card wrapper for iframe embedding */}
      <div className="mx-auto my-6 w-full max-w-xl rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        {/* JOIN NOW SECTION (below the form) */}
        {!isSignup ? (
          <section>
            ...
            <p className="mt-2 text-sm leading-6 text-neutral-600">
              Get unrivaled experiences, mobile check‑in, member rates, in‑room
              Wi‑Fi, and more.
            </p>
            <button
              type="button"
