...
function CalabogieSearchBar() {
  ...
  return (
    <div className="w-full flex justify-center">
      ...
      <div className="w-[92%] max-w-3xl bg-white/35 backdrop-blur rounded-[1.25rem] md:rounded-[20px] shadow-xl border border-white/40 px-4 py-4 md:px-6 md:py-4 h-[95px]">
        {/* Desktop */}
        {!isMobile ? (
