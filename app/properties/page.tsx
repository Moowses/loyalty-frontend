...
export default function PropertiesPage() {
    ...
    for (const url of candidates) {
      try {
        ...
        if (r.ok) {
          ...
          if (Array.isArray(g) && g.length) gallery = g;
          break;
        }
      } catch {
        // ignore and fallback
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
      {/* Search Bar (keep design like before) */}
      <div className="w-full flex justify-center mb-8">
        <div className="w-full max-w-7xl bg-white/95 backdrop-blur rounded-[1.25rem] md:rounded-[20px] shadow-xl border border-gray-200 px-4 py-4 md:px-6 md:py-4 h-[95px]">
          {/* Desktop */}
          {!isMobile ? (
            <div className="flex items-center md:justify-start gap-4 h-full">
              {/* Property */}
              ...
              <button
                type="button"
                disabled={!canSearch}
                className={`w-full md:w-auto font-semibold px-6 py-3 md:px-8 md:py-3 rounded-full inline-flex items-center justify-center transition ${
                  canSearch ? "bg-[#F05A28] hover:brightness-95" : "bg-[#F05A28] opacity-70 cursor-not-allowed"
                } text-white`}
                onClick={() => {
            ...
            /* Mobile */
            <div className="w-full flex items-stretch bg-white border border-gray-300 rounded-xl overflow-hidden shadow-sm h-full">
              {/* Property */}
              ...
              <button
                type="button"
                disabled={!canSearch}
                className={`px-4 font-semibold bg-[#F05A28] text-white ${canSearch ? "" : "opacity-70 cursor-not-allowed"}`}
                onClick={() => {
            ...
            return (
              ...
              >
                <div className="flex flex-col md:flex-row">
                  {/* Image */}
                  <div className="relative w-full md:w-[320px] h-[220px] bg-gray-100">
                    <Image
                      src={hero}
                      alt={p.propertyName}
                      fill
                  ...
                  <div className="flex-1 p-5">
                    <div className="text-[16px] md:text-[17px] font-semibold text-gray-900">
                      {p.propertyName}
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t flex items-center justify-between gap-4">
                      <div className="text-xs text-gray-500">
                        ID: <span className="font-semibold text-gray-800">{p.hotelId}</span>
                        {p.hotelNo ? (
                          <>
                            {" "}
            ...
            <>
              ...
              >
                ...
                <div className="flex justify-end gap-2 pt-2">
                  ...
                  <button
                    className="px-4 py-2 rounded-lg text-white bg-[#F05A28] hover:brightness-95"
                    onClick={() => setShowGuests(false)}
                  >
                    Apply
                  </button>
      ...
      {/* Calendar popover (desktop + mobile) */}
      {mounted && showCal
        ? createPortal(
            <div className="fixed inset-0 z-[99999] pointer-events-none">
              ...
              {isMobile ? (
                // Mobile: bottom sheet
                <div
                  className="absolute inset-x-0 bottom-0 max-h-[92vh] bg-white rounded-t-2xl shadow-2xl p-4 animate-[slideup_200ms_ease-out] overflow-y-auto pointer-events-auto"
                ...
                <div
                  ...
                  onClick={(e) => e.stopPropagation()}
                >
                  <div className="relative z-[100000] text-gray-700 bg-white border rounded-2xl shadow-2xl p-4 w-[860px] pointer-events-auto">
